...
export async function POST(request: Request) {
  try {
    const body: { username?: string; email?: string; password?: string; cuisinePreferences?: string[]; dietaryRestrictions?: string[]; marketingEmailOptIn?: boolean } = await request.json()
