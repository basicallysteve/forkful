...
ALTER TABLE "recipes" ADD COLUMN IF NOT EXISTS "serves" integer;--> statement-breakpoint
ALTER TABLE "recipes" ADD COLUMN IF NOT EXISTS "nutrition_complete" boolean DEFAULT true NOT NULL;--> statement-breakpoint
...
END $$;
--> statement-breakpoint
ALTER TABLE "ingredients" DROP COLUMN IF EXISTS "calories";
